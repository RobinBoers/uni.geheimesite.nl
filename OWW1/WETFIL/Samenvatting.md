...
| -------------------- | ------------------------------------------------------------------------------------ | -------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Empirisch-analytisch | **Nomothetisch**: het formuleren van wetten die algemene regelmatigheden beschrijven | Kwantitatief   | **3<sup>e</sup> persoon**: alleen van buitenaf observeren, nooit participeren | **Waardenvrij**: persoonlijke waarden mogen geen rol spelen en het onderzoek niet kleuren |
| Intepretatief | **Ideografisch**: individuele/unieke casussen doorgronden | Kwalitatief   | **1<sup>e</sup> persoon**: onderzoeker moet de wereld vanuit het perspectief van de deelnemers zien | **Waardenverheldering**: duidelijk zijn over eigen persoonlijke waarden die mogelijk het onderzoek kunnen kleuren |
...
<details>
  ...
  <p>Een punt of onderscheid dat gemaakt wordt door een positivist is niet automatisch positivistisch! Een aantal veelvoorkomende misconcepties:</p>
  <ul>
    <li>
      <p>

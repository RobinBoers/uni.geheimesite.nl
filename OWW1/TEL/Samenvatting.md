...
<!--
- **Digitale competentie**: kennis, vaardigheden, houding, strategieën en waarden die nodig zijn voor het gebruik van ICT op bepaalde competentiegebieden:
...
- **Digitale geletterdheid**: individuele, technologische, sociale vaardigheden die nodig zijn voor het effectief interpreteren, beheren, delen en creeëren van waarde met behulp van digitale communicatie.
-->
...
<details>
  <summary>Andere frameworks die wereldwijd gebruikt worden:</summary>
  <ul>
    <li>The framework for ICT literacy proposed by the American Educational Testing Service (Educational Testing Service, 2002)</li>
    <li>The SAMR framework (Puentedura, 2006)</li>
    <li>The Technological Pedagogical Content Knowledge TPACK Framework (Mishra & Koehler, 2006)</li>
    <li>The UNESCO ICT Competency Standards for Teachers, (UNESCO, 2008)</li>
    <li>The Jisc’s Digital Literacies Framework (JISC, 2014)</li>
    <li>The Common Digital Competence Framework for Teachers (INTEF, 2017)</li>
    <li>The UNESCO ICT Competency Framework For Teachers, (UNESCO, 2011 & 2018)</li>
    <li>The Teacher Digital Competency (TDC) framework (Falloon, 2020)</li>
  </ul>
</details>
...
#### Computer-mediated communication <small>CMC</small>
...
<!--
Taken moeten de volgende aspecten bevatten:
...
- **Gamification**: <span title="time pressure, points, levels, risk, rewards, missions, role-play, leaderboards">game-elementen</span> integreren in bestaand non-game lesmateriaal.

<!--
#### Out-of-class learning

Out-of-class learning houdt in dat lerenden in andere (informelere) contexten dan het klaslokaal leren (eg. excursie, pauze, naschools).

Een voorbeeld is <abbr title="Mobile Assisted Language Learning">MALL</abbr>, waarbij een leerling buiten de klas met een smartphone aan de slag gaat. Dat heeft een aantal "voordelen":

- Directe toegang tot informatie
- Gebruik maken van sociale interactie
- Situatie-relevante ondersteuning
